...
static NSString* const kQualityResultFaceMaskKey         = @"result.face.mask";
...
static NSString* const kQualityResultFaceMaskScoreKey           = @"result.face.mask.score";
...
static NSString* const kQualityResultLeftEyePositionKey         = @"result.eyes.left.position";
static NSString* const kQualityResultRightEyePositionKey        = @"result.eyes.right.position";
...
/*!
 @brief Check if a face mask is used
 */
@property (nonatomic, readonly) BOOL hasMask;

/*!
@brief Get the face rectangle. Coordinates are based on portrait mode.
*/
...
/*!
 @brief Face frontal pose is within thresholds.
 */
@property (nonatomic, readonly) BOOL hasAcceptableFrontalPose;
...
/*!
 @brief Get face mask confidence.
 */
@property (nonatomic, readonly) float faceMaskConfidence;
