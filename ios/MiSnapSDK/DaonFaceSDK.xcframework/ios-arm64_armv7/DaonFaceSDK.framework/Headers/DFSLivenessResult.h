...
static NSString* const kLivenessPauseKey = @"liveness.pause";
/*!
...
typedef NS_ENUM (NSUInteger, LivenessState) {
    LivenessStateNone,
    LivenessStateInitializing,
    LivenessStateStart,
    LivenessStateTracking,
    LivenessStateAnalyzing,
    LivenessStateDone
};

typedef NS_ENUM (NSUInteger, LivenessAlert) {
    LivenessAlertNone               = 0,
    LivenessAlertFaceNotDetected    = 1,
    LivenessAlertFaceNotCentered    = 2,
    ...
    LivenessAlertSpoofDetected      = 9,            // Passive liveness was not detected
    
    LivenessAlertInsufficientFaceData   = 10,
    LivenessAlertInsufficientFrameData  = 11,
    LivenessAlertFrameMismatch          = 12,
    LivenessAlertNoMovementDetected     = 13,
};
 ...
 */
@property (nonatomic, readonly) LivenessState state;
