...
/*!
* @abstract Creates and returns the 32 bit RGBA data.
* @param image The image object
* @return A byte array with RGBA data
* @discussion The necessary memory is allocated based on the pixel dimensions. Call free() when done with the data.
*/
+ (unsigned char*) createRGBADataFromImage:(UIImage*)image;
 ...
 * @abstract Rotate image.
 * @param image The image object
 * @param orientation The UIImageOrientation to rotate to.
 * @return A rotated image object.
 */
...
/*!
 * @abstract Return faces found in an image.
 * @param image The image in portrait orientation or "card" orientation.
 * @return List of face images if any was found.
 */
+ (NSArray<UIImage*>*) findFacesInImage:(UIImage *)image;
