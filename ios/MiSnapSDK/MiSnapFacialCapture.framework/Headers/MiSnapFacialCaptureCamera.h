...
/*!
 ...
 @note
 recordVideo property of MiSnapFacialCaptureCameraParameters should be set to TRUE to enable MiSnapFacialCapture to record videos
 */
...
/**
 ...
 Delegates of a MiSnapFacialCaptureCamera instance that imlement the MiSnapFacialCaptureCameraDelegate protocol will receive the defined callbacks.
